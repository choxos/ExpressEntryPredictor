# Generated by Django 4.2.16 on 2025-08-02 11:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("predicted_invitations", models.IntegerField(blank=True, null=True)),
                ...
                ("uncertainty_range", models.JSONField(blank=True, default=dict)),
                (
                    "category",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
